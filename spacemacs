...
you should place your code here."
  ...
  (global-set-key (kbd "M-p o a o") 'origami-open-all-nodes)
  (global-set-key (kbd "M-p o n") 'origami-next-fold)
  (global-set-key (kbd "M-p o o") 'origami-open-node)
  (global-set-key (kbd "M-p o c") 'origami-close-node)
  (global-set-key (kbd "M-p o p") 'origami-previous-fold)
  (global-set-key (kbd "M-p o m") 'spacemacs/fold-transient-state/origami-reset)
